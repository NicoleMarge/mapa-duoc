...
# --- 2. INICIALIZACIÓN DE AUTENTICACIÓN (Formato Directo) ---
# Eliminamos 'secret_path' para evitar el TypeError. Pasamos los datos directamente.
auth = Authenticate(
...
if not st.session_state.get('connected'):
    ...
    st.markdown("---")
    st.info("Bienvenido. Por favor, inicia sesión con tu cuenta institucional de Google.")
...
with col_busq:
    search_query = st.text_input("Ingresa sala o nombre:", placeholder="Ej: 412, Casino...")

img_path = None

# Lógica de filtrado y selección de imagen
if search_query and not df.empty:
    ...
    if not resultado.empty:
        ...
        # Determinar qué imagen mostrar según el edificio
...
if img_path:
    if os.path.exists(img_path):
        ...
        st.error(f"No se encuentra el mapa: {img_path}")
